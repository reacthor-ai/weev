...
const products = [
  {
    ...
    image: 'https://cdn.leonardo.ai/users/655cab70-b1ba-4eb5-b878-3ba0ec055fc5/generations/4cfe9579-6a35-4aa4-888b-8e45bc551392/Default_Photorealisticthe_Electrolux_UltraQuiet_EcoWash_contro_0.jpg',
    title: 'ElectroLux Washing Machine ECO',
    description: 'Photorealistic,a washing machine. Subtly incorporate the washing machine in a realistic beautiful kitchen in the background, out of focus, suggesting eco-conscious choices.'
  },
  {
              ...
              <div className='grid gap-2.5 p-4'>
                ...
                <div className='flex items-center gap-4'>
                  <div className='grid gap-0.5'>
                    <h2 className='text-xl font-bold leading-none'>{product.title}</h2>
                    <p className='text-sm my-2 leading-none'>{truncateWords(100, product.description)}</p>
                  </div>
                </div>
              </div>
              <div className='border-t border-gray-200 dark:border-gray-800' />
              <div className='flex items-center justify-between p-4'>
                <Link className='text-sm font-medium ml-4 flex items-center' href={linkToEdit}>
